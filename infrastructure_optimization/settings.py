"""
Django settings for infrastructure_optimizer project.
...
SECRET_KEY = 'django-insecure-l4hzqns2zc9$@8b!h1sg(twf0x37p6*)$*-#@0^)x&+i64lz58'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'drf_yasg',
    'infrastructure_optimization.core',
    'ingestion',
    'analysis',
    'recommendations',
    'frontend',
...
WSGI_APPLICATION = 'infrastructure_optimization.wsgi.application'
...
# Seuils pour la detection d'anomalies
ANOMALY_THRESHOLDS = {
    'cpu_usage': 80,
    'memory_usage': 85,
    'latency_ms': 500,
